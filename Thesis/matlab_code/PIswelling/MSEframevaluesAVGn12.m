...
PIframevaluesAVGn12 = []; %Define empty array where all data will be saved.
...
PIframevaluesAVGn12 = vertcat(PIframevaluesAVGn12,tempvalue);
...
Time = toc
save('PIframe_valAVGn12.mat','PIframevaluesAVGn12','Time') %Saving to file
