...
thinfilm = [1.6]; %Defining Refractive index limits.
thickness = [250:1:550]; %Defining Thickness limits.

PIframevaluesAVGn12n16 = []; %Define empty array where all data will be saved.
...
PIframevaluesAVGn12n16 = vertcat(PIframevaluesAVGn12n16,tempvalue);
...
Time = toc
save('PIframe_valAVGn12n16.mat','PIframevaluesAVGn12n16','Time') %Saving to file
