...
%Thinfilm=[1.4:0.1:2];
%Thickness=[250:1:550];
load PIframe_valAVGn12n16.mat 
framevalues = PIframevaluesAVGn12n16;
...
title({'Solvent concentration in polyisoprene during SVA','with constant refractive index 1.2 and constant thin film refractive index 1.6'})
xlabel('Time (seconds)')
...
title({'Polyisoprene with constant refractive index 1.2','and constant thin film refractive index 1.6'})
xlabel('Seconds')
...
axis([0 10000 1.4 1.7])
yticks([1.4 1.5 1.6 1.7])
...
figure('units','normalized','outerposition',[0 0 1 1])
    ...
    axis([0 10000 0 2.5])
    title({'Mean square error of polyisoprene under solvent vapour annealing','with constant refractive index 1.2 and constant thin film refractive index 1.6'})
    xlabel('Seconds')
