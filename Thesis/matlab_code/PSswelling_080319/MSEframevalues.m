...
PSframevalues2 = []; %Define empty array where all data will be saved.

%%%%%%%%%%%%%
% Load data %
%%%%%%%%%%%%%

load PSreflectance2 %Load reflectance measurements for PS -471x642- 471 SVA Measurements.

x = wavelength;

% For loop for fitting each SVA measurement.
for z = 1:length(PSreflectance2(:,1))

y = PSreflectance2(z,(51:501));
...
PSframevalues2 = vertcat(PSframevalues2,tempvalue);



end

save('PSframe_val2.mat','PSframevalues2') %Saving to file
