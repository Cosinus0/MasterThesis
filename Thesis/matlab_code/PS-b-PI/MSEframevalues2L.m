...
PSbPIframevalues2L = []; %Define empty array where all data will be saved.
...
PSbPIframevalues2L = vertcat(PSbPIframevalues2L,tempvalue);



end

save('PSbPIframe_val2L.mat','PSbPIframevalues2L') %Saving to file
