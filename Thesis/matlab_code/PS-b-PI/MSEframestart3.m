...
PSbPIframevaluesstart3 = []; %Define empty array where all data will be saved.
...
PSbPIframevaluesstart3 = vertcat(PSbPIframevaluesstart3,tempvalue);

Time = toc;

save('PSbPIframevalstart3.mat','PSbPIframevaluesstart3','Time') %Saving to file
