...
air = [1.1]; %Defining Refractive index limits.
thinfilm = [1.8]; %Defining Refractive index limits.
thickness = [95:1:200]; %Defining Thickness limits.

framevaluesAVGn11n18 = []; %Define empty array where all data will be saved.
...
framevaluesAVGn11n18 = vertcat(framevaluesAVGn11n18,tempvalue);
...
Time = toc
save('frame_valnAVGn11n18.mat','framevaluesAVGn11n18','Time') %Saving to file
