...
thickness = [40:1:100]; %Defining Thickness limits.

PSbPIframevaluesstart2 = []; %Define empty array where all data will be saved.
...
PSbPIframevaluesstart2 = vertcat(PSbPIframevaluesstart2,tempvalue);

Time = toc;

save('PSbPIframevalstart2.mat','PSbPIframevaluesstart2','Time') %Saving to file
