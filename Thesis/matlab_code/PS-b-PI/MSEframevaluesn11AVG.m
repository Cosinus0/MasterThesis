...
thinfilm = [1.5:0.1:2]; %Defining Refractive index limits.
thickness = [95:1:200]; %Defining Thickness limits.

framevaluesAVGn11 = []; %Define empty array where all data will be saved.
...
framevaluesAVGn11 = vertcat(framevaluesAVGn11,tempvalue);
...
Time = toc
save('frame_valnAVGn11.mat','framevaluesAVGn11','Time') %Saving to file
