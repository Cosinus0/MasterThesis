...
%Thinfilm=[1.5:0.1:2];
%Thickness=[95:1:200];
load frame_valnAVGn11n18.mat
framevalues = framevaluesAVGn11n18;
...
title({'Solvent concentration in Polystyrene-b-polyisoprene during SVA','with constant ambient refractive index 1.1 and constant thin film refractive index 1.8'})
xlabel('Time (seconds)')
...
title({'Polystyrene-b-polyisoprene with constant ambient refractive index 1.1','and constant thin film refractive index 1.8'})
xlabel('Seconds')
...
ylabel('Thickness')
axis([0 10000 75 200])
yticks([75 100 125 150 175 200])
legend('Thickness','Running Thickness')
hold on
hline([100 125 150 175],{'k:','k:','k:','k:'},{'','','','',''})
line1 = vline([1000 2000 3000 4000 5500 6500 7500 8500 9500],{'k:','k:','k:','r:','r:','k:','k:','k:'},{'','','','Max swelling','','','',''});
hold off
...
figure('units','normalized','outerposition',[0 0 1 1])
    ...
    axis([0 10000 0 3.5])
    title({'Mean square error of Polystyrene-b-polyisoprene under solvent vapour annealing','with constant ambient refractive index 1.1 and constant thin film refractive index 1.8'})
    xlabel('Seconds')
...
v = VideoWriter('PSbPIAVGn11n18.avi');
v.FrameRate = 10;
open(v);
