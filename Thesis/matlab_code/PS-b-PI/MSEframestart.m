...
thickness = [0:1:100]; %Defining Thickness limits.

PSbPIframevaluesstart = []; %Define empty array where all data will be saved.
...
PSbPIframevaluesstart = vertcat(PSbPIframevaluesstart,tempvalue);

Time = toc;

save('PSbPIframevalstart.mat','PSbPIframevaluesstart','Time') %Saving to file
