...
load Neighbourhoodfit2layerframevaluesswell.mat %Variable called framevalues
...
framevaluestotal = framevalues;
Time = toc;

save('Neighbourhoodfit2layerframevaluestotal','framevaluestotal','Time')
