...
framevaluesn01 = []; %Define empty array where all data will be saved.
...
framevaluesn01 = vertcat(framevaluesn01,tempvalue);
...
Time = toc
save('frame_valn01.mat','framevaluesn01','Time') %Saving to file
