...
framevaluesn15 = []; %Define empty array where all data will be saved.
...
framevaluesn15 = vertcat(framevaluesn15,tempvalue);
...
Time = toc
save('frame_valn15.mat','framevaluesn15','Time') %Saving to file
