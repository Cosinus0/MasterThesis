...
air = [1.2]; %Defining Refractive index limits.
thinfilm = [1.8]; %Defining Refractive index limits.
thickness = [250:1:600]; %Defining Thickness limits.

PSframevalues160319AVG2 = []; %Define empty array where all data will be saved.
...
PSframevalues160319AVG2 = vertcat(PSframevalues160319AVG2,tempvalue);
...
save('PSframe_val160319AVG2.mat','PSframevalues160319AVG2','Time') %Saving to file
