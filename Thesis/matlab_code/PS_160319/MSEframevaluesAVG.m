...
PSframevalues160319AVG = []; %Define empty array where all data will be saved.
...
PSframevalues160319AVG = vertcat(PSframevalues160319AVG,tempvalue);
...
save('PSframe_val160319AVG.mat','PSframevalues160319AVG','Time') %Saving to file
