...
PSframevalues160319n15 = []; %Define empty array where all data will be saved.
...
PSframevalues160319n15 = vertcat(PSframevalues160319n15,tempvalue);
...
save('PSframe_val160319n15.mat','PSframevalues160319n15','Time') %Saving to file
