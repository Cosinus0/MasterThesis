...
figure('units','normalized','outerposition',[0 0 1 1])
    plot((12:length(ambientinvestreflectance(:,1))).*10,
	framevalues(12:length(ambientinvestreflectance(:,1)),1))
    axis([0 11000 1 1.4])
...
figure('units','normalized','outerposition',[0 0 1 1])
    plot((12:length(ambientinvestreflectance(:,1))).*10,
	framevalues(12:length(ambientinvestreflectance(:,1)),2).*length(wavelength),'k.')
    axis([0 11000 0 0.3])
